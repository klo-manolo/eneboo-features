...
/////////////////////////////////////////////////////////////////
//// BOE2011 ///////////////////////////////////////////////////
class boe2011 extends proveed {
    function boe2011( context ) { proveed ( context ); }
    function datosReciboCli(curFactura:FLSqlCursor):Boolean {
        return this.ctx.boe2011_datosReciboCli(curFactura);
    }
}
//// BOE2011 /////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
//// BOE2011 ///////////////////////////////////////////////////
function boe2011_datosReciboCli(curFactura:FLSqlCursor):Boolean
{
    if (!this.iface.__datosReciboCli(curFactura))
    return false;

    this.iface.curReciboCli.setValueBuffer("nomodelo347", curFactura.valueBuffer("nomodelo347"));
