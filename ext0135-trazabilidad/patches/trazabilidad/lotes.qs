...
A la hora de dar de alta un movimiento de salida, asociado a una línea de albarán o factura de cliente, se mostrarán únicamente como candidatos los lotes del artículo seleccionado que todavía tienen un stock positivo. Por defecto aparecerá el lote con menor fecha de caducidad.
*/
