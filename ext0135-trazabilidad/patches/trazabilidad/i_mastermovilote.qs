...
function oficial_origenDest(nodo: FLDomNode, campo: String): String {
  ...
  switch (docOrigen)
  {
    case "AC" : {
      ...
      if (idAlbaran)
        valor = util.translate("scripts", "Albarán: %1 del cliente %2: %3").arg(util.sqlSelect("albaranescli", "codigo", "idalbaran = " + idAlbaran)).arg(util.sqlSelect("albaranescli", "codcliente", "idalbaran = " + idAlbaran)).arg(util.sqlSelect("albaranescli", "nombrecliente", "idalbaran = " + idAlbaran));
      break;
    }
    case "FC" : {
    ...
    case "AP" : {
      ...
      if (idAlbaran)
        valor = util.translate("scripts", "Albarán: %1 del proveedor %2: %3").arg(util.sqlSelect("albaranesprov", "codigo", "idalbaran = " + idAlbaran)).arg(util.sqlSelect("albaranesprov", "codproveedor", "idalbaran = " + idAlbaran)).arg(util.sqlSelect("albaranesprov", "nombre", "idalbaran = " + idAlbaran));
      break;
    }
    case "FP" : {
