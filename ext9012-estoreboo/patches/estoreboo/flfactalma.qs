...
class fluxEcommerce extends traducciones {
	...
	function beforeCommit_provincias(cursor:FLSqlCursor):Boolean {
        	return this.ctx.fluxEcommerce_beforeCommit_provincias(cursor);
        }
	function beforeCommit_pasarelaspago(cursor:FLSqlCursor):Boolean {
        	return this.ctx.fluxEcommerce_beforeCommit_pasarelaspago(cursor);
        }
	function beforeCommit_parametrospasarela(cursor:FLSqlCursor):Boolean {
        	return this.ctx.fluxEcommerce_beforeCommit_parametrospasarela(cursor);
        }
	...
	function afterCommit_provincias(cursor:FLSqlCursor):Boolean {
        	return this.ctx.fluxEcommerce_afterCommit_provincias(cursor);
    	}
	function afterCommit_pasarelaspago(cursor:FLSqlCursor):Boolean {
        	return this.ctx.fluxEcommerce_afterCommit_pasarelaspago(cursor);
        }
	function afterCommit_parametrospasarela(cursor:FLSqlCursor):Boolean {
        	return this.ctx.fluxEcommerce_afterCommit_parametrospasarela(cursor);
        }
...
function fluxEcommerce_beforeCommit_provincias(cursor:FLSqlCursor):Boolean {
    return this.iface.setModificado(cursor);
}
function fluxEcommerce_beforeCommit_pasarelaspago(cursor:FLSqlCursor):Boolean {
    return this.iface.setModificado(cursor);
}
function fluxEcommerce_beforeCommit_parametrospasarela(cursor:FLSqlCursor):Boolean {
    return this.iface.setModificado(cursor);
}
...
function fluxEcommerce_afterCommit_provincias(cursor:FLSqlCursor):Boolean {
    return this.iface.registrarDel(cursor);
}

function fluxEcommerce_afterCommit_pasarelaspago(cursor:FLSqlCursor):Boolean {
    return this.iface.registrarDel(cursor);
}

function fluxEcommerce_afterCommit_parametrospasarela(cursor:FLSqlCursor):Boolean {
    return this.iface.registrarDel(cursor);
}
