...
//////////////////////////////////////////////////////////////////
//// IVAINCLUIDO + BARCODE ///////////////////////////////////////
class ivaBarcode extends ivaIncluido /** %from: oficial */ {
    function ivaBarcode( context ) { ivaIncluido ( context ); }
	function imprimirTiquePOS(codComanda:String, impresora:String, qry:FLSqlQuery) {
		return this.ctx.ivaBarcode_imprimirTiquePOS(codComanda, impresora, qry);
	}
}
//// IVA INCLUIDO ///////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
//// IVAINCLUIDO + BARCODE ///////////////////////////////////////
function ivaBarcode_imprimirTiquePOS(codComanda:String, impresora:String, qryTicket:FLSqlQuery)
{
	var util:FLUtil = new FLUtil;
	flfact_tpv.iface.establecerImpresora(impresora);

// 	var qryTicket:FLSqlQuery = new FLSqlQuery("tpv_i_comandas2");
// 	qryTicket.setWhere("tpv_comandas.codigo = '" + codComanda + "'");
// 	if (!qryTicket.exec())
// 		return false;
