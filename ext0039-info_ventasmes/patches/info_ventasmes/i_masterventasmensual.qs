...
function oficial_lanzar()
{
	...
	q.setWhere("facturascli.fecha >= '" + fechaInicio + "'" + whereFechaFin + whereEjercicio + whereFamilia + whereSerie + wE + "GROUP BY articulos.referencia, articulos.descripcion, facturascli.fecha ORDER BY articulos.referencia, fecha");
